    ...
    <div class="hero__inner">
      <div class="hero__content">
        ...
        <div class="hero__actions">
          <a href="https://www.npmjs.com/package/vue3-email-template-editor" class="hero__btn hero__btn--primary" target="_blank" rel="noopener">
            ...
            npm i vue3-email-template-editor
          </a>
          <a href="https://github.com/thong-elfie/vue3-email-template-editor" class="hero__btn hero__btn--ghost" target="_blank" rel="noopener">
    ...
    <div class="hero__editor">
      <div class="editor-showcase" :class="{ 'editor-showcase--visible': loaded }">
        ...
        <div class="editor-showcase__chrome">
          ...
          <span class="editor-showcase__chrome-title">{{ currentTemplate.label }} — vue3-email-template-editor</span>
        </div>
        <!-- Editor layout -->
